...
const wallTerms = [
  {
    term: "anchor",
    definition:
      "A structural tie inserted deep into stable ground and tensioned to resist lateral soil pressure, often used behind vertical faces or retaining structures.",
  ...
  },
  {
    term: "bin wall",
    definition:
      "A mass structure assembled from adjacent soil-filled units, typically metal or concrete, stacked without interlocks to resist earth pressure through their combined weight.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    ...
    definition:
      "A reinforced wall system with a stem fixed to a base slab, relying on wall mass and soil weight to stabilize, while the vertical stem acts as a cantilever to resist pressure.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "crib wall",
    definition:
      "An open-face gravity structure built from interlocking frames of timber, concrete, or metal, filled with soil to add both mass and shear strength.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "drilled shaft",
    definition:
      "A deep foundation formed by boring a hole and filling it with concrete, often constructed in rows or clusters to resist horizontal and vertical soil forces.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "gabion",
    definition: "A wire or mesh container filled with stone or soil, stacked to resist erosion or retain fill through mass and permeability.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "gravity wall",
    definition:
      "A freestanding structure built from heavy material such as concrete or stone, relying solely on its own mass to resist lateral earth pressure.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "lagging",
    definition:
      "Horizontal members placed between piles or shafts to retain soil, typically made of timber for temporary use or steel or concrete for long-term support.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    ...
    definition:
      "A fill system reinforced with layers of metal or geosynthetic strips connected to facing panels, forming a mass that behaves like a gravity wall.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    ...
    definition:
      "A segmental system using stacked interlocking masonry or concrete units, sometimes reinforced, designed to hold back soil through friction and mass.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "pile",
    definition:
      "A long, slender element driven or drilled into soil to support vertical or lateral loads, typically made from steel, concrete, or treated timber.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "retaining wall",
    definition:
      "A structure built to hold soil at a steep angle or abrupt elevation change, using mass, reinforcement, or anchorage to resist lateral pressure.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    ...
    definition:
      "A wall formed from interlocking metal sheets driven into the ground to resist horizontal loads, often used in tight spaces or with limited excavation.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    term: "soil nails",
    definition:
      "Slender steel bars inserted and grouted into soil to create internal reinforcement, typically installed closely spaced to stabilize steep cuts.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
  {
    ...
    definition:
      "A wall constructed using vertical piles spaced at intervals, with lagging placed between to hold soil, often used in temporary or anchored applications.",
    discipline: "retaining wall design",
    page: ["glossary-additional-tab"],
  },
];
...
const words = [
  ...
  {
    term: "Local Scour",
    definition: "The localized erosion around bridge piers, abutments, or other structures due to the flow of water, often weakening the foundation.",
  },
  {
    term: "Streambed Scour",
    definition:
      "Erosion of the bed of a stream or river due to the force of flowing water, often exacerbated by the presence of bridge supports or other structures.",
  },
  {
    term: "Gully Erosion",
    definition: "The development of deep, wide channels (gullies) as a result of continuous water flow, often from rill erosion.",
  },
];
...
const glossaryAllTerms = [
...

  {
    term: "backer bar",
    definition:
      "A temporary or permanent metal strip placed behind a weld joint to support molten material, ensuring complete fusion and penetration during welding.",
    discipline: "bridge design",
    page: ["glossary-additional-tab"],
  ...
  },
  {
    term: "necking",
    definition:
      "A localized reduction in cross-sectional area of a structural or tensioned element due to excessive tensile stress, often a precursor to fracture.",
    discipline: "bridge design",
    page: ["glossary-additional-tab"],
  },
  {
...
const birmTerms = [
...

  {
    ...
    definition:
      "The maximum amount of tensile stress that a material can withstand before breaking or failing. It is a key property for assessing the durability and performance of materials.",
    discipline: "bridge design",
    page: ["glossary-additional-tab"],
  },
